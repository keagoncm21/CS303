...
void returnIndex(vector<int>& nums) //outputs the index of a number entered
{
    ...
    while (true) 
    {
        ...
        if (cin.fail()) //if something other than an integer is entered, it is caught here
        {
            cin.clear();
            cin.ignore();
            cout << "Your answer must be an integer. Try again." << endl << endl;
        }
        else
            break;
...
void modifyInt(vector<int>& nums) //modifies a specified number to a new number
{
    ...
    while (true)
    {
        ...
        try //try and catch blocks to catch issues with input
        {
            cin >> integer;
        }
        ...
        {
            cout << "A fatal error has occured. Try again." << endl << endl;
            cin.clear();
            cin.ignore();
            continue;
        }
        ...
        {
            cout << "An undefined error has occured. Try again." << endl << endl;
            cin.clear();
            cin.ignore();
            continue;
        }
